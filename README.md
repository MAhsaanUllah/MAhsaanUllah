...
[![Portfolio](https://img.shields.io/badge/Portfolio-Visit_Website-000000?style=for-the-badge&logo=vercel)](https://MAhsaanUllah.github.io)

*Building production-ready AI systems that solve real problems · Lahore, Pakistan 🇵🇰*
...
### 🎓 EduMentor Live — AI Bilingual Tutor *(Deployed · Hackathon)*

![Gemini](https://img.shields.io/badge/Gemini_2.0_Flash-4285F4?style=flat&logo=google&logoColor=white)
![FastAPI](https://img.shields.io/badge/FastAPI-009688?style=flat&logo=fastapi&logoColor=white)
![CloudRun](https://img.shields.io/badge/Google_Cloud_Run-4285F4?style=flat&logo=googlecloud&logoColor=white)

Real-time multimodal tutoring app — live screen vision + native audio. English & Urdu bilingual support. Built for Google Gemini Live API Hackathon.

| | |
|---|---|
| 🌐 Live | [Open App](https://edumentor-live-278756071986.us-central1.run.app) |
| 🎙️ Tech | Gemini 2.0 Flash · WebSocket · WebRTC · Web Audio API |
| ☁️ Deploy | Google Cloud Run |
| 🏆 Event | Google Gemini Live API Hackathon |

🔗 [View Repository](https://github.com/MAhsaanUllah/Edumentor-Live)

---

### 🔒 SentinelFix AI — Automated Security Orchestration *(GitLab Hackathon)*

![Claude](https://img.shields.io/badge/Claude_3.5-D97706?style=flat&logo=anthropic&logoColor=white)
![GitLab](https://img.shields.io/badge/GitLab_CI/CD-FC6D26?style=flat&logo=gitlab&logoColor=white)
![Python](https://img.shields.io/badge/Python-3776AB?style=flat&logo=python&logoColor=white)

Multi-agent system that scans, analyzes, and auto-fixes security vulnerabilities using tiered Claude AI models — fully integrated with GitLab CI/CD.

| | |
|---|---|
| 🤖 Agents | Scanner agent + Remediation fixer agent |
| 🧠 AI | Claude 3.5 Haiku (scan) · Claude 3.5 Sonnet (fix) |
| 🔄 Pipeline | GitLab CI/CD integrated |
| 🏆 Event | GitLab AI Hackathon 2026 |

🔗 [View Repository](https://github.com/MAhsaanUllah/SentinelFix-AI)
...
Real-time CV pipeline: webcam → MediaPipe hand landmarks → gesture classifier → OS mouse control at 30 FPS. Includes full pytest suite and MIT license.

| | |
|---|---|
| ⚡ Speed | 30 FPS real-time inference |
| 🧠 Model | Keras · Dense + Dropout · EMA smoothing |
| ✅ Tests | Full pytest suite · headless CI compatible |
| 📜 License | MIT Open Source |

🔗 [View Repository](https://github.com/MAhsaanUllah/GestureMouseCV)
...
| Area | Technologies |
|---|---|
| **AI / ML** | PyTorch · TensorFlow · Scikit-learn · XceptionNet · BERT · Transformers |
| **AI Agents** | LangChain · n8n · Gemini API · Pinecone · Claude API · RAG Systems |
| **Backend** | FastAPI · Python 3.11 · REST APIs · PostgreSQL · SQLite · Redis |
...
| [desktop-media-ai-organizer](https://github.com/MAhsaanUllah/desktop-media-ai-organizer) | AI-powered file organizer | MobileNetV2 · Streamlit |
| [MediVision-AI-Disease-Predictor](https://github.com/MAhsaanUllah/MediVision-AI-Disease-Predictor) | Medical disease prediction | Scikit-learn · Streamlit |
| [Retail-Sales-Forecasting-Pipeline](https://github.com/MAhsaanUllah/Retail-Sales-Forecasting-Pipeline) | Sales forecasting · ARIMA + Prophet | Pandas · Streamlit |
